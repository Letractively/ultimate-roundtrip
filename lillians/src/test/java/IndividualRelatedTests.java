...
public class IndividualRelatedTests {
    ...
    public void getAllInstancesOfACLass() {
        ...
        //todo skrive dem ut? trenger i alle fall navn p� dem...
        assertEquals(10, individuals.size());
    } //todo kan bruke query for � hente dem lettere ut? hvordan leser man resultatet lettest?
    ...
    //todo utgangspunktet er at man ha en individual -> trenger s� alle egenskaper ved denne, eller kan man sjekke noen utvalgte?
