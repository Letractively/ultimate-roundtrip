...
public class RankingTest {
    ...
    /*
    byttet ut med sp�rring i stedet - denne g�r ikke p� affinities for en person, men for alle med affinities
    @Test
    public void testFindPreferenceProductRelation() {
        ...
        //F� tak i hvor mye bill bryr seg om eco
        ...
        //Jo, det betyr at man skal se p� om det er WOP er �kologisk eller regular
    ...
    private void addBoosters(List<OWLIndividual> allAffinities, Map<OWLIndividual, SimpleSortable> jamMap) {
        for (OWLIndividual jam : jamMap.keySet()) {
            ...
            for (OWLIndividual affinity : allAffinities) {
                //Sjekke om Affinitien har noe � gj�re med Way of production og s�nt
                if (isAffinityRelatedToProductInformation(affinity, jam)) {
                    ...
                    //todo trenger disse � hardkodes? finnes det en m�te hvor man kan summere alle aktuelle delrelevanser hvor det er en match mellom preferanse og et produkts egenskap?
                    ...
                    //todo n�dvendigheten av denne er avhengig av framgangsm�ten for personaliseringen - skal vi bruke verdier eller relevant/ikke relevant
                    //todo i stedet for delrelevans og summen av disse, kan man i stedet ser p� relevans i seg selv og ikke graden av det
